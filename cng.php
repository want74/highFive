                ...
                <div class="row">
                    <div class="col-6 mx-auto">
                        <div class="row" style="margin-top: 20vh;">
                            <h1 class="head-reg">Создать новость</h1>
                        </div>
                        <div class="row">
                            <p class="text-reg">Для успешного создания заполните следующее... </p>
                        </div>
                        <div class="row">
                            <div class="col">
                                <form action="createnewsg.php" method="post" class="w-100">
                                    <div class="row mt-4">
                                        <div class="col">
                                            <div class="row">
                                                <p class="login">Заголовок новости</p>
                                            </div>
                                            <div class="row">
